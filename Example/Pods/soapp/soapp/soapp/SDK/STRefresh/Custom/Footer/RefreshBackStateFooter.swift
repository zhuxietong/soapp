...
class RefreshBackStateFooter: RefreshBackFooter {
    ...
    override func prepare() {
        ...
        // 初始化文字
        setTitle(title: RefreshBackFooterIdleText, state: RefreshState.Idle)
        setTitle(title: RefreshBackFooterPullingText, state: RefreshState.Pulling)
        setTitle(title: RefreshBackFooterRefreshingText, state: RefreshState.Refreshing)
        setTitle(title: RefreshBackFooterNoMoreDataText, state: RefreshState.NoMoreData)
    }
