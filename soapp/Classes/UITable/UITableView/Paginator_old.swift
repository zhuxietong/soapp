...
//
//
//public extension Paginator where Self:UIViewController
//{
//
...
//        
//        
//        if let collectionV = self.pagingScrollView as? UICollectionView
//        {
//            
//            collectionV.backgroundView = self.backMsgView
//            
...
//            if page_type == .full
//            {
//                collectionV.refreshHeader = RefreshNormalHeader() {
//                    
//                    
...
//                }
//                
//                collectionV.refreshFooter = RefreshAutoNormalFooter() {
//                    wself?.pageRequest()
//                }
//                
//                
...
//            {
//                
//                tableV.refreshHeader = RefreshNormalHeader() {
//                    wself?.paginator.page = PageConfig.page_begin - 1
//                    wself?.pageRequest()
//                }
//                
//                tableV.refreshFooter = RefreshAutoNormalFooter() {
//                    wself?.pageRequest()
//                }
//
//            }
...
//            case .top,.full:
//                self.pagingScrollView.refreshHeader?.endRefreshing()
//            default:
//                break
//            }
//            
//            switch self.paginator.type {
//            case .bottom,.full:
//                self.pagingScrollView.refreshFooter?.resetNoMoreData()
//            default:
//                break
//            }
//        }
//        else
//        {
//            self.pagingScrollView.refreshFooter?.endRefreshing()
//            
//        }
//        if end
//        {
...
//            switch self.paginator.type {
//            case .bottom,.full:
//                self.pagingScrollView.refreshFooter?.noticeNoMoreData()
//            default:
//                break
//            }
//            
...
//        if let tableV = self.pagingScrollView as? UITableView
//        {
//            tableV.refreshHeader?.beginRefreshing()
...
//        if let tableV = self.pagingScrollView as? UITableView
//        {
//            tableV.refreshFooter?.beginRefreshing()
//            //            tableV.performSelector(#selector(UITableView.refreshHeader), withObject: nil, afterDelay: 0.1)
//        }
//        
//        if let tableV = self.pagingScrollView as? UICollectionView
